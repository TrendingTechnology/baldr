...
const getters = {
   ...
   * @param {Number} direction - `1`: next, `-1`: previous
   *
   * @returns {module:@bldr/presentation/content-file~routerParams}
   */
...
const actions = {
  ...
  setNavListNosByRoute ({ commit, getters, dispatch }, route) {
    ...
    dispatch('presentation/setSlideAndStepNoCurrent', slideAndStepNos, { root: true })
  }
}
