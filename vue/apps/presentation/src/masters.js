 ...
 *
 * @module @bldr/presentation/masters
 */
...
class Master {
  ...
  constructor (specs) {
     ...
     *
     * @type {module:@bldr/presentation/masters~MasterIcon}
     */
    this.icon = null
     ...
     * `master`).
     *
     * @type {module:@bldr/presentation~propsDef}
     */
    this.propsDef = null
  ...
  /**
   * Generate the name of the Vuex module, e. g. `presentation/masters/camera`.
   *
   * @returns {String}
   * @private
   */
  vuexModuleName_ () {
    return `presentation/masters/${this.name}`
  }
  ...
  registerVuexModule_ () {
    if (this.store) {
      ...
      store.registerModule(['presentation', 'masters', this.name], this.store)
    }
  }
   ...
   *
   * @param {module:@bldr/presentation~props} props
   *
   * @returns {object}
   */
   ...
   *
   * @param {module:@bldr/presentation~props}
   *
   * @returns {Set}
   */
  ...
  /**
   * @param {object} payload
   * @property {module:@bldr/presentation~props} payload.props
   * @property {module:@bldr/presentation~props} payload.propsMain
   * @property {module:@bldr/presentation~props} payload.propPreview
   *
   * @returns {String}
   */
