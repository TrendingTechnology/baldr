...
_run_test lib/universal/client-media-models
_run_test lib/universal/config
_run_test lib/universal/dom-manipulator
...
_run_test lib/universal/songbook-core
_run_test lib/universal/string-format
_run_test lib/universal/tex-templates
