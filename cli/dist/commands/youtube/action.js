...
async function downloadVideo(cmd, youtubeId, parentDir) {
    return await new Promise((resolve, reject) => {
        const command = childProcess.spawn('youtube-dl', [
            '--format',
...
export default async function action(youtubeId) {
    const meta = (await requestYoutubeApi(youtubeId));
    if (meta == null) {
