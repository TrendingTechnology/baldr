...
export declare const metaTypes: {
    ...
    typeSpecs: {
        cloze: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        composition: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        cover: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        group: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        instrument: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        person: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        photo: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        radio: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        recording: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        reference: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        score: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        song: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        worksheet: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        youtube: import("@bldr/type-definitions/dist/node/meta-spec").Type;
        general: import("@bldr/type-definitions/dist/node/meta-spec").Type;
    };
