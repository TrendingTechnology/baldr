 ...
 */
export declare type Name = 'cloze' | 'composition' | 'cover' | 'documentation' | 'famousPiece' | 'group' | 'instrument' | 'person' | 'photo' | 'radio' | 'recording' | 'reference' | 'score' | 'song' | 'videoClip' | 'worksheet' | 'youtube' | 'general';
/**
