...
exports.traverseMenu = exports.normalizeKeyboardShortcuts = void 0;
/**
 ...
 * @returns A recursive array of processed menu items.
 */
function traverseMenu(input, func) {
    const newMenu = [];
    traverseMenuItemList(input, newMenu, func);
    return newMenu;
}
exports.traverseMenu = traverseMenu;
const menuTemplate = [
    {
        label: 'Datei',
        submenu: [
