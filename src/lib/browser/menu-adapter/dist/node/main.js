...
function getEletronMenuDef(shell, window) {
    return traverse_1.traverseMenu(definition_1.universalMenuDefinition, menu_item_1.convertMenuItemElectron, {
        shell,
        window
    });
}
...
function getWebappMenuDef(router, actions) {
    return traverse_1.traverseMenu(definition_1.universalMenuDefinition, menu_item_1.convertMenuItemWebapp, {
        router,
        actions
    });
}
...
function registerShortcuts(router, shortcuts, actions) {
    traverse_1.traverseMenu(definition_1.universalMenuDefinition, menu_item_1.registerShortcut, {
        router,
        shortcuts,
        actions
    });
