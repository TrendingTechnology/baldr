...
exports.formatUrl = exports.formatId = exports.getHtmlBody = exports.getFirstImage = void 0;
...
function queryWiki(language, params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield axios_1.default.get(`https://${language}.wikipedia.org/w/api.php`, { params });
 ...
 */
function getFirstImage(title, language = 'de') {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function formatId(language, title) {
