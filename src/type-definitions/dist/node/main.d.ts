 ...
 */
export declare type MediaPropName = string;
 ...
 */
export declare type MediaTypeName = 'cloze' | 'composition' | 'cover' | 'group' | 'instrument' | 'person' | 'photo' | 'radio' | 'recording' | 'reference' | 'score' | 'song' | 'worksheet' | 'youtube' | 'general';
/**
 ...
 * ```
 */
export declare type MediaTypeSpecCollection = {
    [key in MediaTypeName]: MediaTypeSpec;
};
/**
 ...
 */
export declare type MediaTypeNames = string;
/**
 * Some actual data which can be assigned to a meta type.
 */
export declare type MediaTypeData = object;
export interface MediaTypeDataAndSpec {
    typeData: AssetFileFormatGeneric;
    typeSpec: MediaTypeSpec;
}
export declare type ValidateFunc = (value: any) => boolean;
export declare type FinalizeFunc = (dataAndSpec: MediaTypeDataAndSpec) => AssetFileFormatGeneric;
export declare type FormatFunc = (value: any, dataAndSpec: MediaTypeDataAndSpec) => any;
