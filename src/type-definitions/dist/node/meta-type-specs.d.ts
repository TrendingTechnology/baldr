...
export declare namespace MetaDataSpec {
    interface Lol {
    }
}
/**
...
declare type WikidataFormatFunc = (value: string, arg: TypeDataAndSpec) => string;
/**
 * The name of a property.
 */
export declare type MetaPropName = string;
export declare type MediaState = 'absent' | 'present';
/**
 ...
 */
export declare type MetaTypeName = 'cloze' | 'composition' | 'cover' | 'group' | 'instrument' | 'person' | 'photo' | 'radio' | 'recording' | 'reference' | 'score' | 'song' | 'worksheet' | 'youtube' | 'general';
/**
...
declare type InitializeFunc = (arg: TypeDataAndSpec) => AssetFileFormatGeneric;
 ...
 * ```
 */
export declare type MetaTypeSpecCollection = {
    [key in MetaTypeName]: MetaTypeSpec;
};
/**
 ...
 */
export declare type MetaTypeNames = string;
/**
 * Some actual data which can be assigned to a meta type.
 */
export declare type MetaTypeData = object;
export interface TypeDataAndSpec {
    typeData: AssetFileFormatGeneric;
    typeSpec: MetaTypeSpec;
}
export declare type ValidateFunc = (value: any) => boolean;
export declare type FinalizeFunc = (dataAndSpec: TypeDataAndSpec) => AssetFileFormatGeneric;
export declare type FormatFunc = (value: any, dataAndSpec: TypeDataAndSpec) => any;
...
export declare type DeriveFunc = (arg: DeriveFuncArg) => any;
...
export declare type DetectTypeByPathFunc = (arg: MetaTypeSpec) => RegExp;
export {};
