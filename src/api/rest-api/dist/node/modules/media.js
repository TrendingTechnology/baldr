        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = (_a = response).json;
                    return [4 /*yield*/, api_1.database.getPresentation(request.params.scheme, request.params.authority)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = (_a = response).json;
                    return [4 /*yield*/, api_1.database.getAsset(request.params.scheme, request.params.authority)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _b = (_a = response).json;
                    return [4 /*yield*/, api_1.database.getAllAssetRefs()];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _b = (_a = response).json;
                    return [4 /*yield*/, api_1.database.getAllAssetUuids()];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _b = (_a = response).json;
                    return [4 /*yield*/, api_1.database.getAllAssetUris()];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [3 /*break*/, 3];
                case 2:
