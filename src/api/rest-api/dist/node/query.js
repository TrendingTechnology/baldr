...
exports.extractBoolean = exports.extractString = void 0;
/**
 ...
 */
function extractString(query, key, defaultValue) {
 ...
 */
function extractBoolean(query, key, defaultValue) {
    if (key in query) {
        var value = query[key];
        if (value === false ||
            value === 'false' ||
    ...
    throw new Error("No value could be found for the boolean query parameter \u201C".concat(key, "\u201D in the parsed query object."));
}
