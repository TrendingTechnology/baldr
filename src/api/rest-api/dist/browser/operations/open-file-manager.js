 ...
 */
export default function (ref, mediaType, openArchiveFolder, createParentDir, dryRun) {
    if (dryRun === void 0) { dryRun = false; }
    return __awaiter(this, void 0, void 0, function () {
        var absPath, parentFolder, parentFolders, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getAbsPathFromRef(ref, mediaType)];
                case 1:
                    absPath = _a.sent();
                    ...
                    if (!dryRun) {
                        if (openArchiveFolder) {
                            results = openArchivesInFileManager(parentFolder, createParentDir);
