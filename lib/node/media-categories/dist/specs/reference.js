...
function readReferencesYaml() {
    const rawReferences = readYamlFile(path.join(config.mediaServer.basePath, 'Quellen.yml'));
    const result = {};
...
export const reference = {
    ...
    props: {
        ...
        approvalNumber: {
            ...
            description: 'Lehrplan-Plus: https://www.km.bayern.de/download/18655_5_Gymnasium_LPPLUS.pdf G8-Lehrplan: https://www.km.bayern.de/download/21243_4_Gymnasium.pdf',
            derive: function ({ filePath }) {
