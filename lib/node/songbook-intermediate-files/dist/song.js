...
// Project packages.
import { SongMetaDataCombined, songConstants } from '@bldr/songbook-core';
...
class ExtendedSongMetaData {
    ...
    constructor(folder) {
        ...
        this.rawYaml = convertFromYamlRaw(fs.readFileSync(ymlFile, 'utf8'));
 ...
 * One song
 */
export class ExtendedSong {
    folder;
    abc;
    songId;
    metaData;
    metaDataCombined;
    folderIntermediateFiles;
    /**
