...
let packageFolder = path.join(new URL('.', import.meta.url).pathname, '..', 'packages', 'electron-app')
...
describe('Package “@bldr/songbook-electron-app”', function () {
  ...
  describe('application launch', function () {
    ...
    beforeEach(function () {
      process.env.BALDR_SONGBOOK_PATH = path.resolve(new URL('.', import.meta.url).pathname, 'songs', 'real')
