...
async function fetchResizeFile(url, dest) {
 ...
 */
export async function fetchCommonsFile(fileName, dest) {
 ...
 */
export function mergeData(data, dataWiki, categoryCollection) {
 ...
 */
export async function query(itemId, typeNames, categoryCollection) {
