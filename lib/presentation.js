...
class Presentation {
   ...
   * @param {array} extensions Relative or absolute path of a folder or a file.
   ...
   * @param {string} extension A file extension to filter the result
   * @return {array} A array of absolute file paths.
   */
  normalizeInputPath(inputPath, extension=false) {
    let absPath = this.absolutePath(inputPath);

    if (!fs.existsSync(absPath)) {
      throw Error(`The specified path “${absPath}” does not exist!`);
    }
