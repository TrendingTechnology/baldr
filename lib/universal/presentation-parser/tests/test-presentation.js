  ...
  describe('meta', function () {
    describe('Real world example: 12/10_Interpreten/10_Konzertierende-Musiker/20_Konzertwesen', function () {
      ...
      it('Accessor “ref”', function () {
        assert.strictEqual(presentation.ref, 'ref:Konzertwesen')
      })

      describe('Accessor “uuid”', function () {
        it('meta.uuid present', function () {
          assert.strictEqual(
            presentation.uuid,
            'uuid:35f5146c-3c98-4493-b9b9-534eba361e12'
          )
        })

        it('undefined in meta.uuid', function () {
          const presentation = parsePresentation('masters/audio')
          assert.strictEqual(presentation.uuid.length, 41)
        })
      })
