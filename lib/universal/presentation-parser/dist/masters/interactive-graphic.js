...
export const inkscapeModeNames = ['layer', 'layer+', 'group', 'none'];
export class InteractiveGraphicMaster {
    constructor() {
        ...
        this.fieldsDefintion = Object.assign({ src: {
                ...
                description: 'layer (Inkscape-Ebenen), layer+ (Elemente der Inkscape-Ebenen), group (Gruppierungen), none (Alles eingeblendet)',
                default: 'layer',
                validate: (input) => {
