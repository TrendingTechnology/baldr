...
async function queryWiki(language, params) {
    ...
    const response = await getHttp(`https://${language}.wikipedia.org/w/api.php`, { params });
 ...
 */
export async function queryFirstImage(title, language = DEFAULT_LANGUAGE) {
 ...
 */
export async function queryHtmlBody(title, language, oldid) {
