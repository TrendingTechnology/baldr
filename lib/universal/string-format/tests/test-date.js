...
describe('File “date.ts”', function () {
  it('Function “formatToYear()”', function () {
    assert.strictEqual(formatToYear('1978-12-03'), '1978')
  })
  ...
  it('Function „formatToLocalDateTime()”', function () {
    assert.strictEqual(formatToLocalDateTime(1641633840000), 'Sa 2022-1-8 10:24:00')
  })
