...
export class Resolver {
     ...
     */
    async queryMediaServer(uri, throwException = true) {
     ...
     *  cannot be resolved (default: `true`).
     */
    async resolveSingle(uri, throwException = true) {
     ...
     *  cannot be resolved (default: `true`).
     */
    async resolve(uris, throwException = true) {
        ...
        while (urisWithoutFragments.size > 0) {
            ...
            for (const asset of await Promise.all(promises)) {
                if (asset != null) {
