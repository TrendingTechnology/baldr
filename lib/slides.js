 ...
 * @constructor
 */
var Slides = function(yamlFile, document, presentation) {
 ...
 */
Slides.prototype.instantiateSlide = function(slide, index) {
  let no = index + 1;
  let master = Object.keys(slide)[0];
  let masterPath = path.join(__dirname, '..', 'masters', master);
  let {Master} = require(masterPath);
  return new Master({
