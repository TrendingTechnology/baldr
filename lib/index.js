...
class BaldrSongbookSearch extends HTMLElement {
  ...
  constructor() {
    ...
    for (let songID in songsList) {
      option = document.createElement('option');
      option.setAttribute('value', songID);
      option.innerHTML = songsList[songID].title;
      select.appendChild(option);
    }
 ...
 * </pre></code>
 */
const songsList = flattenTree(songsTree);
...
var main = function() {
  ...
  tableOfContents(songsTree, document.getElementById('toc-field'));
